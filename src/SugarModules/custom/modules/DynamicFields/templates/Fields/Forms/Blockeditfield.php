...
require_once('custom/modules/DynamicFields/templates/Fields/TemplateBlockeditfield.php');
...
function get_body(&$ss, $vardef)
{
    ...
    return $ss->fetch('custom/modules/DynamicFields/templates/Fields/Forms/Blockeditfield.tpl');
}
?>
